               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工号" prop="sijiUuidNumber">
                       <el-input v-model="ruleForm.sijiUuidNumber"
                                 placeholder="工号" clearable  :readonly="ro.sijiUuidNumber"></el-input>
                   </el-form-item>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="手机号" prop="sijiPhone">
                       <el-input v-model="ruleForm.sijiPhone"
                                 placeholder="手机号" clearable  :readonly="ro.sijiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="司机工龄" prop="sijiNumber">
                       <el-input v-model="ruleForm.sijiNumber"
                                 placeholder="司机工龄" clearable  :readonly="ro.sijiNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   sijiNumber: [
                              { required: true, message: '司机工龄不能为空', trigger: 'blur' },
                          ],
                   sijiEmail: [
